...
public class AddressManager5 implements LevelManager {

    private static AddressManager5 instance;
    private XMLHelper xmlHelper;

    private AddressManager5() 
    {
        this.xmlHelper = new XMLHelper();
    }

    public static AddressManager5 getInstance() 
    {
        if (instance == null) 
            instance = new AddressManager5();
