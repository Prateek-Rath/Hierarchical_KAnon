...
public class RunQuery
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        /* use query params instead of hardcoding */
        ...
        String ruleFile   = params.get("ruleFile");
        String queryXPath = params.get("queryXPath");
        String userRole   = params.get("userRole");
        String outputPath = params.get("outputPath");
        // "../data/filtered-output.xml"
        ...
        // Write output XML
        xmlHelper.writeXML(filteredDoc, outputPath);
